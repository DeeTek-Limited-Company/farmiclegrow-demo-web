...
export function CinematicHero({ 
  brandName = "Farmicle",
  tagline1 = "Track the harvest,",
  tagline2 = "from seed to market.",
  cardHeading = "Traceability, redefined.",
  cardDescription = <><span className="text-white font-semibold">FarmicleGroww</span> empowers farmers and buyers with structured accountability, precise supply chain tracking, and beautiful visual timelines.</>,
  metricValue = 5000,
  metricLabel = "Active Farms",
  ctaHeading = "Start your journey.",
  ctaDescription = "Join thousands of farmers in the agricultural revolution and take control of your supply chain today.",
  className, 
  ...props 
}: CinematicHeroProps) {
  ...
  return (
    <div
      ref={containerRef}
      className={cn("relative w-[100%] h-screen overflow-hidden flex items-center justify-center bg-background text-foreground font-sans antialiased", className)}
    ...
    >
      ...
      <div className="hero-text-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-[100%] px-4 will-change-transform transform-style-3d">
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-[100%] px-4 gsap-reveal pointer-events-auto will-change-transform">
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <a href="/login" aria-label="Join the Platform" className="btn-modern-light flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2">
            <div className="text-center">
              <div className="text-[10px] font-bold tracking-wider text-neutral-500 uppercase mb-[-2px]">Join the Platform</div>
              <div className="text-xl font-bold leading-none tracking-tight">Get Started</div>
            </div>
          </a>
          <a href="/marketplace" aria-label="Explore Market" className="btn-modern-dark flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-background">
            <div className="text-center">
              <div className="text-[10px] font-bold tracking-wider text-neutral-400 uppercase mb-[-2px]">Explore Market</div>
              <div className="text-xl font-bold leading-none tracking-tight">Browse Now</div>
            </div>
          </a>
        </div>
      </div>
        ...
        >
          ...
          <div className="relative w-full h-full max-w-7xl mx-auto px-4 lg:px-12 flex flex-col justify-evenly lg:grid lg:grid-cols-3 items-center lg:gap-8 z-10 py-6 lg:py-0">
            ...
            <div className="card-right-text gsap-reveal order-1 lg:order-3 flex justify-center lg:justify-end z-20 w-full">
              <h2 className="text-5xl md:text-6xl lg:text-8xl font-black uppercase tracking-tighter text-card-silver-matte lg:mt-0">
                {brandName}
              </h2>
            </div>
            ...
            <div className="mockup-scroll-wrapper order-2 lg:order-2 relative w-full h-[380px] lg:h-[600px] flex items-center justify-center z-10" style={{ perspective: "1000px" }}>
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      <div className="phone-widget flex justify-between items-center mb-8">
                        <div className="flex flex-col">
                          ...
                          <span className="text-xl font-bold tracking-tight text-white drop-shadow-md">Crop Health</span>
                        </div>
                        <div className="w-9 h-9 rounded-full bg-white/5 text-neutral-200 flex items-center justify-center font-bold text-sm border border-white/10 shadow-lg shadow-black/50">FG</div>
                      </div>
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Harvest Ready</p>
                    <p className="text-emerald-200/50 text-[10px] lg:text-xs font-medium">Milestone unlocked</p>
                  </div>
                </div>
                ...
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Logistics Secured</p>
                    <p className="text-indigo-200/50 text-[10px] lg:text-xs font-medium">Buyer matched successfully</p>
                  </div>
                </div>
