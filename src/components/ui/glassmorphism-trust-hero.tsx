...
// --- MOCK BRANDS ---
const CLIENTS = [
  { name: "GreenValley Co-op", icon: Sprout },
  { name: "FreshLogistics", icon: Truck },
  { name: "AgriTrade Network", icon: Building2 },
  { name: "EcoSeed", icon: Wheat },
  { name: "HarvestGlobal", icon: Tractor },
  { name: "FarmTech Solutions", icon: ShieldCheck },
];
  ...
  return (
    <div className="relative w-full bg-zinc-950 text-white overflow-hidden font-sans">
      ...
      */}
      ...
      <div 
        className="absolute inset-0 z-0 bg-[url('https://images.unsplash.com/photo-1592982537447-6f2a6a0c5c8e?auto=format&fit=crop&q=80&w=3840')] bg-cover bg-center opacity-30"
        style={{
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center space-y-8 pt-8">
            ...
            <div className="animate-fade-in delay-100">
              <div className="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/10 px-3 py-1.5 backdrop-blur-md transition-colors hover:bg-primary/20">
            ...
            <p className="animate-fade-in delay-300 max-w-xl text-lg text-zinc-400 leading-relaxed">
              We design digital infrastructure that combines transparency with profitability,
              creating seamless supply chains that farmers love and buyers trust.
            </p>
          ...
          <div className="lg:col-span-5 space-y-6 lg:mt-12">
            ...
            <div className="animate-fade-in delay-500 relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl shadow-2xl">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <div>
                    <div className="text-3xl font-bold tracking-tight text-white">5,000+</div>
                    <div className="text-sm text-zinc-400">Farmers Onboarded</div>
                  </div>
                </div>
                ...
                <div className="space-y-3 mb-8">
                  <div className="flex justify-between text-sm">
                    <span className="text-zinc-400">Produce Traceability</span>
                    <span className="text-white font-medium">100%</span>
                  </div>
                  <div className="h-2 w-full overflow-hidden rounded-full bg-zinc-800/50">
                    <div className="h-full w-[100%] rounded-full bg-gradient-to-r from-emerald-500 to-white" />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-4 text-center">
                  ...
                  <StatItem value="24/7" label="Agronomist Support" />
                  <div className="w-px h-full bg-white/10 mx-auto" />
            ...
            <div className="animate-fade-in delay-500 relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 py-8 backdrop-blur-xl">
              <h3 className="mb-6 px-8 text-sm font-medium text-zinc-400">Trusted by Industry Partners</h3>
